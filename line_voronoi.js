// chart 1 market cap
var formatMillion = d3.formatPrefix(",.1f", 1e6),
    formatBillion = d3.formatPrefix(",.1f", 1e9);
...
d3.csv("./data/all_currencies_T_yearMonth.csv", type, function(error, data) {
  ...
  g.append("g")
      ...
      .call(d3.axisLeft(y).ticks(10).tickFormat(formatBillion))
    .append("text")
  ...
  function mouseover(d) {
    ...
    focus.select("text").text(d.data.city.name + ": " + formatMillion(d.data.value));
  }
